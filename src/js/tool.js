require("../scss/tool.scss");
document.getElementById("main").querySelector("h1#loadingpage").remove();

let homepage_content = document.querySelector("[data_store]#toolpage");
...
class Slide {
    constructor() {
      ...
      this.imageUrl = 'assets/images/site/';
    ...
    getBannerItemHTML(imageName) {
      ...
      <a href="blast.html">
      <img src="${this.imageUrl+imageName}.png">
      </a>
      </div>`
    }
